import type { TextlintRuleContextReportFunctionArgs, TextlintRuleError, TextlintRuleErrorPaddingLocation, TextlintSourceCode, TextlintMessageSuggestion } from "@textlint/types";
 ...
 */
export declare const resolveSuggestionsLocation: ({ node, ruleError }: {
    node: TxtNode;
    ruleError: TextlintRuleError;
}) => {
